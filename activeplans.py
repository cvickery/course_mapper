...
ACAD_SUBPLAN_TBL tables. The matching dap_req_block for each plan can be determined directly because
the plan name in ACAD_PLAN_TBL will match the block_value attribute of the dap_req_block. Finding
the matching dap_req_block for a subplan is less straightforward, and there will be cases where the
correct choice among alternative possibilities can't be determined. All anomalies are logged.
